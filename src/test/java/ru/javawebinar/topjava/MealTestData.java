...
public class MealTestData {
    ...
    public static final Meal ADMINMEAL1 = new Meal(MEALID + 7, of(2020, Month.OCTOBER, 25, 14, 0), "milk", 210);
    public static final Meal ADMINMEAL2 = new Meal(MEALID + 8, of(2020, Month.OCTOBER, 26, 21, 0), "sausage", 400);

    public static final List<Meal> MEALS = Arrays.asList(MEAL1, MEAL3, MEAL4, MEAL7, MEAL5, MEAL6, MEAL2);
    public static final List<Meal> MEALSSORTED = Arrays.asList(MEAL7, MEAL6, MEAL5, MEAL4, MEAL3, MEAL2, MEAL1);
